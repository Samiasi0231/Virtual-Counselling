...
function DashboardCard03() {
  ...
  return (
    <div className="flex flex-row gap-6 col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-xs rounded-xl">
      ...
      <div className="flex flex-col items-center justify-center w-40 h-40 mb-4 border rounded shadow bg-white">
    ...
    <h1 className="text-2xl font-bold text-blue-600">120</h1>
        ...
        <header className="flex justify-between items-start mb-2">
          <h2 className="text-lg font-semibold text-purple-800 dark:text-gray-100 mb-2">All users</h2>
             ...
             <div className="flex flex-col items-center justify-center w-40 h-40 border rounded shadow bg-white">
